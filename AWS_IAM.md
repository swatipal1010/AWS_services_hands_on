...
10. Choose the name of the **EC2-Support** group.
...
17. Under **Policy Name**, choose the link for the **AmazonS3ReadOnlyAccess** policy.
...
24. Under **Policy Name**, choose the name of the **EC2-Admin-Policy** policy.
...
26. At the bottom of the screen, choose **Cancel** to close the policy.
...
49. First, sign out *user-2* from the console:
